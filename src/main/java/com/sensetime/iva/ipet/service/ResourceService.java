...
public interface ResourceService {
     ...
     * @return 结果集
     */
    List<Resource> queryResourceAndRolesByPathAndMethod(String path, String method);
     ...
     */
    void setResourceForRole(int roleId , List<Resource> resources);
     ...
     */
    void addResourceForRole(int roleId , int resourceId);
...
//    List<Resource> getMenusByAccountId(int id);
     ...
     */
    void deleteOneResourceRole(int roleId, int resourceId);
